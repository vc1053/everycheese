...
# When we need an instantiated OBJECT a few times => Fixture!
@pytest.fixture
def cheese():
...
''' Test Cheese Detail URL Pattern
    (this is where we use the fixture)'''
